...
STATUS_INTERVAL_MS="${POLYMARKET_STATUS_INTERVAL_MS:-100}"
...
REST_BACKUP_INTERVAL_MS="${POLYMARKET_REST_BACKUP_INTERVAL_MS:-1000}"
...
exec /usr/local/bin/polymarket-live-probe \
  ...
  --state-snapshot-interval-ms "$STATE_SNAPSHOT_INTERVAL_MS" \

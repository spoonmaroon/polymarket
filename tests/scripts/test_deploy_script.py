...
def test_compose_and_env_support_prebuilt_image_overrides() -> None:
    ...
    assert "POLYMARKET_PROBABILITY_MIN_TOTAL_PATHS=20000" in env_example
...
def test_pc_deploy_script_runs_prebuilt_deploy_gate_with_pc_cadence() -> None:
    ...
    assert 'PC_PROBABILITY_MIN_TOTAL_PATHS="${PC_PROBABILITY_MIN_TOTAL_PATHS:-20000}"' in script

...
if [ "$USE_PREBUILT" != "1" ]; then
  COLLECTOR_IMAGE="polymarket-rust-collector:$DEPLOY_SHORT_SHA"
  NORMALIZER_IMAGE="polymarket-normalizer:$DEPLOY_SHORT_SHA"
  CUDA_PROBABILITY_IMAGE="polymarket-cuda-probability:$DEPLOY_SHORT_SHA"
fi

<!-- converted from BTC_Binary_Path_Probability_Incomplete_Research_Paper.before_section4_layout_cleanup_20260529.docx -->
...
A contract can have high p_finish but low p_no_touch. That means the final settlement may still be favorable, but the path is unstable enough that entry is dangerous.
